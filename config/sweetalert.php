...
return [
    ...
    */
    ...
    'customClass' => [
        'container' => env('SWEET_ALERT_CONTAINER_CLASS', 'swal2-container'),
        ...
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'swal2-confirm'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'swal2-cancel'),
