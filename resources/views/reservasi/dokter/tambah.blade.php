...
@section('menu', 'Tambah Jadwal Dokter')
@section('konten')

<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-amber-600">Tambah Jadwal Dokter</h1>
    ...
    <div class="grid md:grid-cols-2 gap-20 border rounded-xl">
        ...
        <div class="bg-amber-100 p-10">
            <form action="" method="post" enctype="multipart/form-data">
                <x-form-reservasi-dokter :uuidRuang="request()->segment(count(request()->segments())-1)" :dokter="$dokter" :ruang="$ruang"/>
            </form>
        </div>
    </div>
    <!-- End Grid -->
