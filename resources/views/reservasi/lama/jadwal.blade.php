...
@section('modal')
<form action="{{ route('admin.reservasi.registrasi.konfirmasi') }}" method="post">
    @csrf
    ...
    <div id="hs-large-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 overflow-x-hidden overflow-y-auto z-[60]">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all lg:max-w-6xl lg:w-full m-3 lg:mx-auto">
            ...
            <div class="flex items-center min-h-full">
                <div class="flex flex-col bg-amber-100 p-3 border shadow-sm rounded-xl h-[90vh] w-screen z-[70]">
                    <div class="flex justify-between items-center py-3 px-4 border-b">
                        <h3 class="font-bold text-gray-800 text-2xl">
                            Jadwal Ketersediaan <span class="text-amber-500"></span>
                        </h3>
                    ...
                    <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
                        ...
                        <button class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-amber-500 text-white hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-all text-sm disabled:bg-amber-300" href="#" type="submit" disabled="disabled" id="tombol-submit">
                            Buat Reservasi
                        </button>
                    </div>
                </div>
