...
@section('menu', 'Buat Reservasi')
@section('konten')

<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-amber-600">Buat Reservasi Pasien</h1>
        ...
        @foreach($pasien as $p)
            ...
            <div class="group flex flex-col h-full bg-amber-100 border border-gray-200 shadow-sm rounded-xl">
                ...
                <div class="p-4 hover:bg-amber-200 hover:rounded-b-xl">
                    <a href="{{ route('admin.reservasi.pasien.tujuan',base64_encode($p->nomor_medis)) }}">
