...
<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-amber-600">Registrasi Dokter</h1>
                ...
                <form action="{{ route('admin.reservasi.registrasi.konfirmasi.simpan') }}" method="post">
                    ...
                    <div class="grid gap-3 2xl:grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nomor_medis_form" id="nomor_medis_form" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-amber-500 focus:ring-amber-500 disabled:bg-slate-200 text-slate-700" value="{{ $pasien->nomor_medis }}" disabled>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama_pasien" id="nama_pasien" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-amber-500 focus:ring-amber-500 disabled:bg-slate-200 text-slate-700" value="{{ $pasien->nama }}" disabled>
                        </div>
                        <div class="col-span-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama_dokter" id="nama_dokter" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-amber-500 focus:ring-amber-500 disabled:bg-slate-200 text-slate-700" value="{{ $dokter['nama_dokter'] }}" disabled>
