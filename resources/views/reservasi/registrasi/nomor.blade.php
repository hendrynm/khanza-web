...
@section('menu', 'Lihat Reservasi')
@section('konten')

<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-amber-600">Lihat Reservasi Pasien</h1>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($pasien as $p)
            ...
            <div class="group flex flex-col h-full bg-amber-100 border border-gray-200 shadow-sm rounded-xl">
                <div class="h-40 flex flex-col justify-center px-5 bg-amber-500 rounded-t-xl text-white leading-tight">
                ...
                <div class="p-4 hover:bg-amber-200 hover:rounded-b-xl">
                    <a href="{{ route('admin.reservasi.registrasi.daftar',base64_encode($p->nomor_medis)) }}">
                        <h3 class="text-sm text-center font-semibold text-amber-500">
                            Pilih
                        </h3>
                    </a>
                </div>
