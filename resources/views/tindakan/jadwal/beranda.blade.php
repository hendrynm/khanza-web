...
@section('menu', 'Tujuan Penjadwalkan')
@section('konten')

<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-red-600">Pilih Tujuan Penjadwalan</h1>
        ...
        @foreach($ruang as $r)
            ...
            <div class="group flex flex-col h-full bg-red-100 border border-gray-200 shadow-sm rounded-xl">
                ...
                <div class="p-4 md:p-6 hover:bg-red-200 hover:rounded-b-xl">
                    <a href="{{ route('admin.tindakan.jadwal.ruang', [$nomor_medis, strtoupper($r->uuid)]) }}">
                        <h3 class="text-xl text-center font-semibold text-red-500">
                            {{ $r->nama_ruang }}
                        </h3>
                    </a>
                </div>
