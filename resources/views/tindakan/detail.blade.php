...
<!-- Page Heading -->
<header>
    <h1 class="text-4xl font-bold text-red-600">Isi Tindakan</h1>
                ...
                <div class="mt-5 md:col-span-2 md:mt-0">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="gejala" name="gejala" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" placeholder="Masukkan gejala yang dialami oleh pasien"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="tanda-vital" name="tanda-vital" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" placeholder="Masukkan hasil tanda vital yang ada pada pasien"></textarea>
                            </div>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <label for="diagnosa1" class="block text-sm font-semibold text-gray-700">Diagnosa 1</label>
                            <select id="diagnosa1" name="diagnosa1" autocomplete="diagnosa1" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="diagnosa2" name="diagnosa2" autocomplete="diagnosa2" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm">
                                <option selected>--- Pilih salah satu ---</option>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="tindakan" name="tindakan" autocomplete="tindakan" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm">
                                <option selected>--- Pilih salah satu ---</option>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="jadwal-tindakan" name="jadwal-tindakan" autocomplete="jadwal-tindakan" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm">
                                <option selected>--- Pilih salah satu ---</option>
                            </select>
                        </div>
                    </div>
