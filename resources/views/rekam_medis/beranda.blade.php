    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($pasien as $p)
            ...
            <div class="group flex flex-col h-full bg-emerald-100 border border-gray-200 shadow-sm rounded-xl">
                <div class="h-40 flex flex-col justify-center px-5 bg-emerald-500 rounded-t-xl text-white leading-tight">
                ...
                <div class="p-4 hover:bg-emerald-200 hover:rounded-b-xl">
                    <a href="{{ route('admin.rekam_medis.profil',base64_encode($p->nomor_medis)) }}">
                        <h3 class="text-sm text-center font-semibold text-emerald-500">
                            Pilih
                        </h3>
                    </a>
                </div>
